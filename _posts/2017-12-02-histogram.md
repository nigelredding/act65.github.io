...
Consider the problem this way. Let $S = \{s_1,\ldots,s_n\}$ be a set of the unique words in our book. For each permutation $\pi$ of $S$, there is a tuple \\[ S_\pi = (s_{\pi(1)}, \ldots, s_{\pi(n)}). ]\\ 
